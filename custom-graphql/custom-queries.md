...
The [Viewer](../core-concepts/viewer.md), which was introduced earlier is never automatically exposed in the GraphQL schema because there's no uniformity in what can be exposed across different products. So if/when this needs to be exposed, it has to be done manually.
...
- [gqlQuery](#gqlquery)
- [gqlField](gql-field.md)
- [gqlObjectType](gql-object-type.md)
- [gqlContextType](gql-context.md)
