---
url: https://ent.dev/docs/custom-graphql/custom-mutations
...
- [gqlInputObjectType](gql-input-object-type.md)
...
Accepts the following options which overlap with [gqlField](gql-field.md):
