---
url: https://ent.dev/docs/actions/edit-action
title: "Edit Action"
description: ""
...
This is done via the `ActionOperation.Edit` or `ActionOperation.Mutations` [operation](../ent-schema/actions.md#operation).
...
`EventEditInput` is an interface that indicates what the input for the action is. What's in there is determined by a combination of the fields in the [schema](action.md#schema) and the [fields](../ent-schema/actions.md#fields) property in the action.
...
To explicitly make a field required in an action, use [requiredField](../ent-schema/actions.md#requiredfield) when configuring it.
