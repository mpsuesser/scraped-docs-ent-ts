---
url: https://ent.dev/docs/advanced-topics/configuration
title: "Configuration"
description: ""
...
- `defaultEntPolicy` configures the [Privacy Policy](../core-concepts/privacy-policy.md) in base class of generated Ents. Overrides the [default privacy policy](../core-concepts/ent.md#privacy-policy). See [PrivacyConfig](#privacyconfig) for the expected format.
- `defaultActionPolicy` configures the [Privacy Policy](../core-concepts/privacy-policy.md) in base class of generated Actions. Overrides the [default privacy policy](../actions/action.md#default-privacy-policy). See [PrivacyConfig](#privacyconfig) for the expected format.
...
- `defaultGraphQLFieldFormat`: default format for fields is lowerCamelCase e.g. firstName. If you wanna change it to snake\_case e.g. first\_name, set this field to snake\_case
...
`devSchema.prune` is a codegen/tooling setting, not a TS runtime setting. It is used when writing the generated state file and by [`tsent prune_schemas`](cli.md#prune_schemas). Runtime `loadConfig` does not prune schemas on connection open.
