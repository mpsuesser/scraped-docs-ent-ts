---
url: https://ent.dev/docs/actions/builder
title: "Builder"
description: ""
...
For the [Schema](action.md#schema), the generated builder looks as follows:
...
Each [Trigger](triggers.md), [Validator](validators.md), and [Observer](observers.md) is passed an instance of the Builder.

The Builder can be used to update the value of fields in a trigger, [add](triggers.md#update-builder) or remove edges or passed in as [input](triggers.md#input) to other fields.
