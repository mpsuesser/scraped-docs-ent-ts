...
This section is only relevant when writing [custom queries](../custom-data-access/custom-queries.md) or to peek under the hood to figure out how things work.
