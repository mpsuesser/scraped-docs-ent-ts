...
[`gqlContextType`](gql-context.md) annotates a method to indicate that it needs the [RequestContext](../core-concepts/context.md#requestcontext) and the generated GraphQL code should pass it down to the method.
...
We'll dive into a specific example of this in [gqlFileUpload](file-uploads.md#gqlfileupload).
